    ...
    <section className="py-20 px-0 bg-secondary/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <p className="text-accent font-semibold mb-2 text-sm sm:text-base">OUR SERVICES</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {services.map((service, idx) => {
            ...
            return (
              <Card
                key={idx}
                className="group p-6 sm:p-8 hover:shadow-2xl transition-all duration-300 hover:border-accent hover:-translate-y-2 bg-card min-h-64 relative overflow-hidden"
              >
