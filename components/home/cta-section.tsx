            ...
            <ul className="space-y-5 mb-12">
              {[
                ...
                <li key={idx} className="flex items-start gap-4">
                  ...
                  <span className="text-base font-medium bg-muted text-foreground">{point}</span>
                </li>
              ))}
            </ul>

            <Link href="/contact">
              <Button className="bg-accent hover:bg-accent/90 text-accent-foreground text-base px-8 py-3">
